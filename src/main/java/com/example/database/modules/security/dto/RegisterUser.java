package com.example.database.modules.security.dto;
 ...
 */
@Data
@NotRecordField(value = "RegisterUser", label = "注册用户表单")
public class RegisterUser {
    ...
    @JsonProperty(access = JsonProperty.Access.READ_ONLY)
    @RecordField(label = "超管")
    private Integer superAdmin;

    @ApiModelProperty(value = "角色ID列表")
    @RecordField(label = "角色id列表")
